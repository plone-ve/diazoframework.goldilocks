...
setup(name='diazoframework.goldilocks',
      version=version,
      ...
      keywords='web zope plone theme diazo goldilocks-approach-css framework',
      author='Thijs Jonkman',
      author_email='t.jonkman@gmail.com',
      maintainer='Leonardo Caballero',
      maintainer_email='leonardocaballero@gmail.com',
      url='https://github.com/TH-code/diazoframework.goldilocks',
      license='GPL',
